...
class AutoTagAssistantAppTest {
    ...
    private static void assertManifestRequestSucceeds(String manifestUrl, String expectedBaseUrl, Consumer<HttpURLConnection> connectionCustomizer) throws Exception {
